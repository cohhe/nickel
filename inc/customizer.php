...
function nickel_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'nickel_general_panel', array(
		'priority'       => 250,
		'capability'     => 'edit_theme_options',
		'title'          => __( 'General settings' , 'nickel'),
		'description'    => __( 'You can configure your general theme settings here' , 'nickel')
	) );

	// Add Header setting panel and configure settings inside it
	$wp_customize->add_panel( 'nickel_header_panel', array(
		'priority'       => 260,
		'capability'     => 'edit_theme_options',
		'title'          => __( 'Header settings' , 'nickel'),
		'description'    => __( 'You can configure your header theme settings here' , 'nickel')
	) );

	// Facebook
	$wp_customize->add_section( 'nickel_header_facebook', array(
		'priority'       => 90,
		'capability'     => 'edit_theme_options',
		'title'          => __( 'Facebook link' , 'nickel'),
		'description'    => __( 'Facebook social icon at header.' , 'nickel'),
		'panel'          => 'nickel_header_panel'
	) );

	$wp_customize->add_setting( 'nickel_header_facebook_icon', array( 'sanitize_callback' => 'sanitize_text_field' ) );

	$wp_customize->add_control(
		'nickel_header_facebook_icon',
		array(
			'label'      => 'Facebook icon link',
			'section'    => 'nickel_header_facebook',
			'type'       => 'text',
		)
	);

	// Twitter
	$wp_customize->add_section( 'nickel_header_twitter', array(
		'priority'       => 90,
		'capability'     => 'edit_theme_options',
		'title'          => __( 'Twitter link' , 'nickel'),
		'description'    => __( 'Twitter social icon at header.' , 'nickel'),
		'panel'          => 'nickel_header_panel'
	) );

	$wp_customize->add_setting( 'nickel_header_twitter_icon', array( 'sanitize_callback' => 'sanitize_text_field' ) );

	$wp_customize->add_control(
		'nickel_header_twitter_icon',
		array(
			'label'      => 'Twitter icon link',
			'section'    => 'nickel_header_twitter',
			'type'       => 'text',
		)
	);

	// G+
	$wp_customize->add_section( 'nickel_header_gplus', array(
		'priority'       => 90,
		'capability'     => 'edit_theme_options',
		'title'          => __( 'Google+ link' , 'nickel'),
		'description'    => __( 'Google+ social icon at header.' , 'nickel'),
		'panel'          => 'nickel_header_panel'
	) );

	$wp_customize->add_setting( 'nickel_header_gplus_icon', array( 'sanitize_callback' => 'sanitize_text_field' ) );

	$wp_customize->add_control(
		'nickel_header_gplus_icon',
		array(
			'label'      => 'Google+ icon link',
			'section'    => 'nickel_header_gplus',
			'type'       => 'text',
		)
	);
